...
const MonthlyParkingRecord = () => {
  const router = useHistory();
  const RAND_ID = '00000000-0000-0000-0000-0000000000';
  const fields = [
    { key: 'name', _style: { width: '20%'} },
    { key: 'carPlate', _style: { width: '20%'} },
    { key: 'startTime', _style: { width: '20%'} },
    { key: 'endTime', _style: { width: '20%'} },
    { key: 'carType', _style: { width: '20%'} },
  ];
  ...
  const handleClick = (e:any) =>{
    ...
    router.push('/report/monthly-parking-record/' + e.id);
  }
  const AddItem =()=>{
    router.push('/report/monthly-parking-record/' + RAND_ID)
  }
  ...
  useEffect(() => {
    ...
    var result = axios.get(`${REACT_APP_APIURL}MonthlyParkingRecord`, {
      headers:{
        'Authorization': `${token}`,
        'ORGID': orgID
      }
...
export default MonthlyParkingRecord
